...
public class QueueTest<E> extends AbstractQueue<E>
    ...
    /**
     * Creates an {@code QueueTest} with the given (fixed)
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public QueueTest(int capacity, boolean fair) {
        if (capacity <= 0)
    ...
    /**
     * Iterator for QueueTest. To maintain weak consistency
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            final ReentrantLock lock = QueueTest.this.lock;
            lock.lock();
            try {
                lastRet = -1;
